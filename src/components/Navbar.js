    ...
    return (
        <div className='flex justify-between px-4 py-3 items-center mb-6 sticky top-0 '>
            ...
            <div className=' flex-row gap-4 lg:gap-5 justify-center hidden md:flex'>
                <p className={NavClass} onClick={() => handleNavigate('')} >Home</p>
                <p className={NavClass} onClick={() => handleNavigate('viewinventory')} >Inventory</p>
                <p className={NavClass} onClick={() => handleNavigate('inventory')}>Add product</p>
            ...
            <div className='mobile-nav absolute left-0 top-16 md:hidden'>
                ...
                <div className='relative z-10'>
                    <div className={`flex flex-col gap-4 bg-white lg:gap-5 h-screen ${nav ? 'w-[150px] ' : 'w-0'} overflow-hidden transition-all ease-in-out duration-300 z-10`}>
